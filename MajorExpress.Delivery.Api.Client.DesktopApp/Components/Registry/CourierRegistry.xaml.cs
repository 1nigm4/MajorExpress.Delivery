...
{
    /// <summary>
    /// Логика взаимодействия для UserRegistry.xaml
    /// </summary>
    public partial class CourierRegistry : UserControl
    {
        public CourierRegistry()
        {
            InitializeComponent();
        }

        public CourierRegistry(CourierRegistryViewModel viewModel) : this()
        {
